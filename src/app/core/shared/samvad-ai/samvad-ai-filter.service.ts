...
import {
  SearchFiltersState,
  SearchFilterState
} from '../../../shared/samvad-ai/samvadAI-filters/search-filter/search-filter.reducer';
...
} from '../../../shared/samvad-ai/samvadAI-filters/search-filter/search-filter.actions';
...
const filterStateSelector = (state: SearchFiltersState) => state.samvadAIFilter;
...
/**
 * Service that performs all actions that have to do with samvad-ai filters and facets
 */
@Injectable()
export class SamvadAIFilterService {
