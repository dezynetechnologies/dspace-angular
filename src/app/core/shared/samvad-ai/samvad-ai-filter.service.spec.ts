import { SamvadAIFilterService } from './samvad-ai-filter.service';
...
import { FilterType } from '../../../shared/samvad-ai/models/filter-type.model';
import { ActivatedRouteStub } from '../../../shared/testing/active-router.stub';
import { of as observableOf } from 'rxjs';
import { SortDirection, SortOptions } from '../../cache/models/sort-options.model';

describe('SamvadAIFilterService', () => {
  let service: SamvadAIFilterService;
  ...
  const samvadAIServiceStub: any = {
    uiSearchRoute: '/samvad-ai'
  };

  beforeEach(() => {
    service = new SamvadAIFilterService(store, routeServiceStub);
  });
  ...
  describe('when the initializeFilter method is triggered', () => {
    ...
    it('SamvadAIFilterInitializeAction should be dispatched to the store', () => {
  ...
  describe('when the collapse method is triggered', () => {
    ...
    it('SamvadAIFilterCollapseAction should be dispatched to the store', () => {
  ...
  describe('when the toggle method is triggered', () => {
    ...
    it('SamvadAIFilterInitialExpandAction should be dispatched to the store', () => {
  ...
  describe('when the decreasePage method is triggered', () => {
    ...
    it('SamvadAIFilterDecrementPageAction should be dispatched to the store', () => {
