...
describe('SamvadAIConfigurationService', () => {
  let service: SamvadAIConfigurationService;
  ...
  beforeEach(() => {
    service = new SamvadAIConfigurationService(routeService, paginationService as any, activatedRoute, linkService, halService, requestService, rdb);
  });
  ...
  describe('when subscribeToSamvadAIOptions or subscribeToPaginatedSamvadAIOptions is called', () => {
    beforeEach(() => {
    ...
    describe('when subscribeToSamvadAIOptions is called', () => {
      beforeEach(() => {
        (service as any).subscribeToSamvadAIOptions(defaults);
      });
    ...
    describe('when subscribeToPaginatedSamvadAIOptions is called', () => {
      beforeEach(() => {
        (service as any).subscribeToPaginatedSamvadAIOptions(defaults.pagination.id, defaults);
      });
  ...
  describe('when getSamvadAIConfigurationFor is called with a scope', () => {
    ...
    beforeEach(() => {
      ...
      service.getSamvadAIConfigurationFor(scope).subscribe((t) => {
  ...
  describe('when getSamvadAIConfigurationFor is called without a scope', () => {
    const endPoint = 'http://endpoint.com/test/config';
    beforeEach(() => {
      spyOn((service as any).halService, 'getEndpoint').and.returnValue(observableOf(endPoint));
      spyOn((service as any).rdb, 'buildFromHref').and.callThrough();
      service.getSamvadAIConfigurationFor(null).subscribe((t) => {
      }); // subscribe to make sure all methods are called
    });
