...
export function filterReducer(state = initialState, action: SearchFilterAction): SearchFiltersState {
  ...
  switch (action.type) {
    ...
    case SearchFilterActionTypes.INITIALIZE2: {
    ...
    case SearchFilterActionTypes.COLLAPSE2: {
      return Object.assign({}, state, {
        [action.filterName]: {
    ...
    case SearchFilterActionTypes.EXPAND2: {
      return Object.assign({}, state, {
        [action.filterName]: {
    ...
    case SearchFilterActionTypes.DECREMENT_PAGE2: {
    ...
    case SearchFilterActionTypes.INCREMENT_PAGE2: {
      return Object.assign({}, state, {
        [action.filterName]: {
          filterCollapsed: state[action.filterName].filterCollapsed,
    ...
    case SearchFilterActionTypes.RESET_PAGE2: {
      return Object.assign({}, state, {
        [action.filterName]: {
          filterCollapsed: state[action.filterName].filterCollapsed,
          page: 1
    ...
    case SearchFilterActionTypes.TOGGLE2: {
      return Object.assign({}, state, {
        [action.filterName]: {
          filterCollapsed: !state[action.filterName].filterCollapsed,
          page: state[action.filterName].page
